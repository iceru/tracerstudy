...
<div class="input-form">
    <form action="{{ route('pertanyaan.updateDirect', $pertanyaan->id) }}" method="post">
        @csrf
        @method('PATCH')
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nama_pertanyaan" id="nama_pertanyaan" value="{{ old('nama_pertanyaan', $pertanyaan->nama_pertanyaan_da) }}">
        </div>
